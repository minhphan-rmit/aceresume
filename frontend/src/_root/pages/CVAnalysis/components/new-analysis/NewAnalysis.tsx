...
const NewAnalysis: React.FC<NewAnalysisProps> = ({ onUploadSuccess }) =>{
    ...
    const handleUpload = (e: FormEvent<HTMLFormElement>) => {
      ...
      const extractData = async (resumeId: string) => {
        ...
        try {
            const response = await axios.post(` ${process.env.REACT_APP_API_BASE_URL}/resume/${userId}/${resumeId}/summarize`, {
            });
      ...
      const analyzingData = async (resumeId: string, resumeInfo: any) => {
        ...
        try {
            const response = await axios.post(
                ` ${process.env.REACT_APP_API_BASE_URL}/resume/${userId}/${resumeId}/analyse`,
                {
    ...
    const handleSubmit = async (url: string) => {
        ...
        try {
            const response = await axios.post(` ${process.env.REACT_APP_API_BASE_URL}/resume/${userId}/upload`, formData, {
                headers: {
