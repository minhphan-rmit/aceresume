...
const Profile = () => {
  ...
  const sentOTP = async () => {
    try {
      const response = await axios.post(` ${process.env.REACT_APP_API_BASE_URL}/forgot_password/${userId}`);
  ...
  const handleVerifyPassword = async () => {
    try {
      ...
      const response = await axios.put(` ${process.env.REACT_APP_API_BASE_URL}/profile_update/${userId}`, formData, {
        headers: {
  ...
  const handleResetPassword = async () => {
    try {
      ...
      const response = await axios.put(` ${process.env.REACT_APP_API_BASE_URL}/reset_password/${userId}`, formData, {
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded',
        },
      });
