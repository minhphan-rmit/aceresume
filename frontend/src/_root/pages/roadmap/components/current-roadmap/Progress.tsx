...
const Progress = ({ score }: { score: number }) => {
    ...
    return (
        ...
        <div className="flex flex-row items-center justify-between w-full">
            ...
            <h5 className="text-sm text-gray-700 mt-4 font-light italic">
                This progress is based on the tasks you have completed
            </h5></div>
            <div className='text-5xl text-indigo-700 font-bold '>{score} <span className='text-gray-700 font-bold text-3xl'> %</span></div>
